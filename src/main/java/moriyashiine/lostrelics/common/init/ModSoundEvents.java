...
public class ModSoundEvents {
	public static final SoundEvent BLOCK_ALTAR_CONVERT = SoundEvent.of(LostRelics.id("block.altar.convert"));
	...
	public static void init() {
		Registry.register(Registries.SOUND_EVENT, BLOCK_ALTAR_CONVERT.getId(), BLOCK_ALTAR_CONVERT);
