...
import moriyashiine.lostrelics.client.render.entity.model.trinket.FaceTrinketRenderer;
import moriyashiine.lostrelics.client.render.entity.model.trinket.NecklaceTrinketRenderer;
...
public class LostRelicsClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		ModelPredicateProviderRegistry.register(ModItems.TURQUOISE_EYE, Identifier.of("broken"), (stack, world, entity, seed) -> RelicItem.isUsable(stack) ? 0 : 1);
		ModelPredicateProviderRegistry.register(ModItems.SMOKING_MIRROR, Identifier.of("broken"), (stack, world, entity, seed) -> RelicItem.isUsable(stack) ? 0 : 1);
		ModelPredicateProviderRegistry.register(ModItems.TRIPLE_TOOTHED_SNAKE, Identifier.of("one"), (stack, world, entity, seed) -> RelicItem.isUsable(stack) && TripleToothedSnakeItem.getCharges(stack) == 1 ? 1 : 0);
		ModelPredicateProviderRegistry.register(ModItems.TRIPLE_TOOTHED_SNAKE, Identifier.of("two"), (stack, world, entity, seed) -> RelicItem.isUsable(stack) && TripleToothedSnakeItem.getCharges(stack) == 2 ? 1 : 0);
		ModelPredicateProviderRegistry.register(ModItems.TRIPLE_TOOTHED_SNAKE, Identifier.of("three"), (stack, world, entity, seed) -> RelicItem.isUsable(stack) && TripleToothedSnakeItem.getCharges(stack) == 3 ? 1 : 0);
		ModelPredicateProviderRegistry.register(ModItems.TRIPLE_TOOTHED_SNAKE, Identifier.of("four"), (stack, world, entity, seed) -> RelicItem.isUsable(stack) && TripleToothedSnakeItem.getCharges(stack) == 4 ? 1 : 0);
		ModelPredicateProviderRegistry.register(ModItems.TRIPLE_TOOTHED_SNAKE, Identifier.of("broken"), (stack, world, entity, seed) -> RelicItem.isUsable(stack) ? 0 : 1);
